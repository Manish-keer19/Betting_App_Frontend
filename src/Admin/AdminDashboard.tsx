...
// // //         <button
// // //           className={`px-4 py-2 rounded-t-lg font-medium text-sm md:text-base ${
...
// //       if (pendingDepositsRes.success) setPendingDeposits(pendingDepositsRes.data);
...
// //       if (pendingWithdrawalsRes.success) setPendingWithdrawals(pendingWithdrawalsRes.data);
...
// //                   {getCurrentTransactions().map((transaction) => (
// //                     <tr key={transaction._id} className="hover:bg-gray-750 transition-colors">
// //                       <td className="px-4 py-3 whitespace-nowrap">
// //                         <div className="flex items-center">
...
// //                       <td className="px-4 py-3 whitespace-nowrap">
// //                         <button
// //                           onClick={() => openImageModal(transaction.paymentScreenshot)}
